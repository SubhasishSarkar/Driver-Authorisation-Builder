export default function generateLetter(state) {
  const letter = `I ${state.ownerName}, ${state.ownerRelation} ${state.ownerGurdian}, ${state.ownerAddress}, by caste ${state.ownerCast} by profession Business, do hearby authorise my driver namely ${state.driverName}, S/O ${state.driverFatherName}, Address: ${state.driverAddress}, being driving License No. ${state.driverLicenseNumber} vehicle registration number ${state.vehicle} in my consent.\n
